   ...
   can_use = function(self, card)
        ...
        for _, v in ipairs(G.hand.highlighted) do
            if SMODS.has_enhancement(G.hand.highlighted[1], 'm_mult') and SMODS.has_enhancement(G.hand.highlighted[2], 'm_glass') or 
               ...
               SMODS.has_enhancement(G.hand.highlighted[1], 'm_gold') and SMODS.has_enhancement(G.hand.highlighted[2], 'm_mult') or
            ...
            G.E_MANAGER:add_event(Event({
                ...
                if SMODS.has_enhancement(G.hand.highlighted[1], 'm_gold') and
                   ...
                   if MILLS.random_chance(.75) then
                        ...
                        G.hand.highlighted[1]:set_ability ("m_mills_rhond",nil,true)
                        end
                    if MILLS.random_chance(.5) then
